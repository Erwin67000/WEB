  ...
  en: {
    ...
    article: {
      ...
      spec: {
        ...
        shelfPositions: 'Shelf height (top)',
        edgeSection: 'Frame section',
        none: 'None',
        modulesSpec: '',
        panelsSpec: '',
    ...
    config: {
      ...
      furniture: 'Pieces',
      fabMeuble: 'List of pieces',
      fabDims: 'Dimensions',
      fabLayout: 'Add functions',
      fabPanels: 'Add panels',
      fabScene: '3D scene',
      ...
      heightTotal: 'Overall height: {h} cm (Hreel + plinth {socle} cm)',
      heightTotalNoSocle: 'Overall height: {h} cm',
  ...
  fr: {
    ...
    article: {
      ...
      spec: {
        ...
        shelfPositions: 'Hauteur tablettes (haut)',
        edgeSection: 'Section d’arête',
        none: 'Aucun',
        modulesSpec: '',
        panelsSpec: '',
        priceTtc: 'Prix TTC',
    ...
    config: {
      ...
      furniture: 'Meubles',
      fabMeuble: 'Liste de meubles',
      fabDims: 'Dimensions',
      fabLayout: 'Ajoute des modules',
      fabPanels: 'Ajoute des panneaux',
      fabScene: 'Scène 3D',
      ...
      heightTotal: 'Hauteur totale : {h} cm (Hreel + socle {socle} cm)',
      heightTotalNoSocle: 'Hauteur totale : {h} cm',
